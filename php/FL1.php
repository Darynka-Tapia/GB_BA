...
if(!isset($_POST['FL1'])) exit('No se recibió el valor a buscar');
...
function FL1()
{
	...
	$mysqli = getConnexion();
	$FL1 = $mysqli->real_escape_string($_POST['FL1']);
		...
		if(mysqli_num_rows($res) != 0){
		  	...
		  	while ($row = $res->fetch_array(MYSQLI_ASSOC)) {
	            ...
	            <div class="row"> 
		  		...
		  		$prestdo="select * from prestamo where folio1 = ".$FL1." || folio2 = ".$FL1."";
