...
ini_set('max_execution_time', 900);
	require '../../archivosEXCEL/Classes/PHPExcel/IOFactory.php';
	require '../../archivosEXCEL/Classes/PHPExcel.php';
	require '../../SQL/conexion.php';

	$nombre_excel=$_FILES['imagen']['name'];
	$tipo_excel=$_FILES['imagen']['type'];
	$tamano_excel=$_FILES['imagen']['size'];
	$carpeta_destino=$_SERVER['DOCUMENT_ROOT'].'/GB-BA/archivosEXCEL/';
